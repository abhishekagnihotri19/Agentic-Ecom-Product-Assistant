...
from etl.data_scrapper import FlipkartScrapper
...
if st.button("🚀 Start Scraping"):
    ...
    if not product_inputs:
        ...
        for query in product_inputs:
            ...
            results = flipkart_scraper.scrap_flipkart_product(query, max_products=max_products, review_count=review_count)
